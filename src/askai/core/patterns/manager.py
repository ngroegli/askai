...
from .inputs import PatternInput, InputGroup, InputType
...
from .display import display_pattern as _display_pattern, select_pattern as _select_pattern
...
class PatternManager:
    ...
    def display_pattern(self, pattern_id: str) -> None:
        ...
        Args:
            pattern_id: The pattern identifier
        """
        _display_pattern(self, pattern_id)
    ...
    def select_pattern(self, tags: Optional[List[str]] = None) -> Optional[str]:
        ...
        """
        return _select_pattern(self, tags)
