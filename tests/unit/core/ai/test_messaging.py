...
sys.modules['askai.utils.config'] = MagicMock()
sys.modules['askai.utils.config'] = MagicMock()

# pylint: disable=wrong-import-position,import-error
from unit.test_base import BaseUnitTest
from askai.core.ai.service import AIService
from askai.core.messaging.builder import MessageBuilder
from askai.core.patterns.inputs import PatternInput, InputType
...
sys.modules['askai.utils.config'].load_config = MagicMock(return_value=mock_config)
sys.modules['askai.utils.config'].load_config = MagicMock(return_value=mock_config)
sys.modules['askai.utils.config'].ensure_askai_setup = MagicMock()
